class ZCL_Z_ABAP_CI_EP_01_MPC definition
  public
...
public section.
  ...
  types:
      begin of TS_ABAPCISUMMARY,
     PACKAGE_NAME type C length 64,
     NUM_ERRORS type I,
     NUM_SUCCESS type I,
     TEST_RESULT type C length 16,
  end of TS_ABAPCISUMMARY .
  types:
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_Z_ABAP_CI_EP_01_MPC=======CP' ##NO_TEXT.
...
CLASS ZCL_Z_ABAP_CI_EP_01_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'Z_ABAP_CI_EP_SRV_01' ).
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_Z_ABAP_CI_EP_01_MPC=>TS_ABAPCISUMMARY' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20200114173205'.                  "#EC NOTEXT
...
clear ls_text_element.
ls_text_element-artifact_name          = 'PackageName'.                 "#EC NOTEXT
